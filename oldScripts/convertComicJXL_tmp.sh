...
#変換後にオリジナルを削除する  ※変換フォーマットがjpgなら [-or -iname "*.jpg"]ははずすように
     #gfind ./ -type f -and \( -iname "*.avif" -or -iname "*.png"  -or -iname "*.jpeg" -or -iname "*.jpg" \) -print0 |	xargs -0 -I {}  echo "File found: {}"
		 #gfind ./ -type f \( -iname "*.avif" -or -iname "*.png" -or -iname "*.jpeg" -or -iname "*.jpg" \)
		 find ./ -type f \( -iname "*.avif" -or -iname "*.png" -or -iname "*.jpeg" -or -iname "*.jpg" \)  -delete
